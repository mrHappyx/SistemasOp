        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    Colas_y_SJF MCP = new Colas_y_SJF(true, false);
                    MCP.ejecutarSimulacion(tiempoSimulacion);
                    break;
                case 2:
                    System.out.println("\nEjecutando Proceso Más Corto Primero (SJF):");
                    System.out.println("Tiempo total de simulación: " + tiempoSimulacion);
                    Colas_y_SJF SJF = new Colas_y_SJF(true, true);
                    SJF.ejecutarSimulacion(tiempoSimulacion);
                    break;
                case 3:
